...
namespace OnlineGraphQLMicroservice.Entities
{
    ...
    {        
        ...
        public double? Concrete_w_c_ratio { get; set; }
        public double Concrete_scm_min { get; set; }
        public double? Concrete_scm_max { get; set; }
        ...
        public double? Steel_bar_elongation_min { get; set; }
        public double? Steel_recycled_content { get; set; }
        public double? Steel_post_consumer_recycled_content { get; set; }
        ...
        public double? Steel_rebar_bending_pin_max { get; set; }
        public double? Steel_rebar_ts_ys_ratio_max { get; set; }
        ...
        //Z stands for standard deviation
        public double Biogenic_embodied_carbon_z { get; set; }
        public string Timber_stored_carbon { get; }
        public double? Timber_stored_carbon_z { get; set; }
        ...
        public double? Acoustics_nrc { get; set; }
        public double? Recycled_content { get; set; }
        ...
        public double? Ceiling_panel__nrc { get; set; }
        public double? Ceiling_panel_cac { get; set; }
